...
fun ControlPanel(
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        ...
        if(entry != secondaryEntry) {
            ControlPanelButton(Icons.Outlined.Checklist) {
        ...
        // Up
        ControlPanelButton(Icons.Outlined.ArrowUpward) {
            onMoveUp(entry)
        }
        ...
        // Down
        ControlPanelButton(Icons.Outlined.ArrowDownward) {
            onMoveDown(entry)
        }
...
@Composable
private fun ControlPanelButton(icon: ImageVector, onClick: () -> Unit) {
    IconButton(
        onClick = onClick,
        ...
        Icon(imageVector = icon, contentDescription = null, modifier = Modifier.padding(5.dp).width(24.dp).height(24.dp))
    }
}

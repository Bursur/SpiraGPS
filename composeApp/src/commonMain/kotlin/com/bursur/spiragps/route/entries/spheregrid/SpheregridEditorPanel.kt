package com.bursur.spiragps.route.entries.spheregrid
...
@Composable
fun SpheregridEditorPanel(entry: Entry, selectedEntry: Entry, conditions: ArrayList<Condition>) {

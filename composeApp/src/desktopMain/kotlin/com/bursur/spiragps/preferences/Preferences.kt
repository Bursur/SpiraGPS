...
actual fun getDarkModePreference(): Int = 1
actual fun getTextSizePreference(): Int = 1
actual fun getDyslexicModePreference(): Int = 1
actual fun getKhaegarModePreference(): Int = 1
